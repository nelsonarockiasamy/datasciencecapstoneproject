...
* The Shiny application can be visualized at the link: [data science application](https://nelsonarockiasamy.shinyapps.io/predict/)
...
* The next word prediction app is hosted on shinyapps.io: [Shiny app](https://nelsonarockiasamy.shinyapps.io/predict/)
